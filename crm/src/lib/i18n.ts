...
const resources = {
  en: {
    translation: {
      ...
      supportBroadcast: {
        ...
        photoOnly: '📷 Photo',
        photoTooLarge: 'Image is too large. Try a smaller photo.',
        ...
        trade: {
          title: 'Trade',
          subtitle: 'Users and available exchanges/assets/arbitrage limits',
          total: 'Total users',
          searchPlaceholder: 'Search by ID, nickname, name...',
          exchangesLimit: 'Exchanges limit',
          assetsLimit: 'Assets limit',
          arbitrageTypeLimit: 'Arbitrage types',
          save: 'Save',
          empty: 'No users found',
        },
      support: {
  ...
  ru: {
    translation: {
      ...
      supportBroadcast: {
        ...
        photoOnly: '📷 Фото',
        photoTooLarge: 'Изображение слишком большое. Попробуйте фото поменьше.',
      ...
      trade: {
        title: 'Trade',
        subtitle: 'Пользователи и лимит доступных бирж/активов/арбитража',
        total: 'Всего пользователей',
        searchPlaceholder: 'Поиск по ID, нику, имени...',
        exchangesLimit: 'Лимит бирж',
        assetsLimit: 'Лимит активов',
        arbitrageTypeLimit: 'Типы арбитража',
        save: 'Сохранить',
  ...
  ua: {
    translation: {
      ...
      trade: {
        title: 'Trade',
        subtitle: 'Користувачі та ліміт доступних бірж/активів/арбітражу',
        total: 'Усього користувачів',
        searchPlaceholder: 'Пошук за ID, ніком, ім’ям...',
        exchangesLimit: 'Ліміт бірж',
        assetsLimit: 'Ліміт активів',
        arbitrageTypeLimit: 'Типи арбітражу',
        save: 'Зберегти',
        empty: 'Користувачів немає',
      },
      deposits: {
