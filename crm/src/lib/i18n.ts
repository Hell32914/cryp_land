...
const resources = {
  en: {
    translation: {
      ...
      supportBroadcast: {
        ...
        trade: {
          title: 'Trade',
          subtitle: 'Users and available exchanges/assets limits',
          total: 'Total users',
          searchPlaceholder: 'Search by ID, nickname, name...',
  ...
  ru: {
    translation: {
      ...
      trade: {
        title: 'Trade',
        subtitle: 'Пользователи и лимит доступных бирж/активов',
  ...
  ua: {
    translation: {
      ...
      trade: {
        title: 'Trade',
        subtitle: 'Користувачі та ліміт доступних бірж/активів',
        total: 'Усього користувачів',
        searchPlaceholder: 'Пошук за ID, ніком, ім’ям...',
