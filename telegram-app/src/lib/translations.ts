...
export const translations = {
  ENGLISH: {
    ...
    upTo: 'Up to',
    gameSubtitle: 'Buy a box and spin the roulette',
    gameTokenBalance: 'Token balance',
    gameTokenLabel: 'tokens',
    gameNotEnough: 'Not enough tokens',
    gameInsufficientTokens: 'Insufficient tokens',
    gameConfirmTitle: 'Confirm purchase',
    gameConfirmText: 'Do you want to buy',
    gameFor: 'for',
    gameRouletteTitle: 'Roulette',
    gameSpinButton: 'Spin',
    gameSpinning: 'Spinning…',
    gameSpinDone: 'Result ready',
    gameBackToBoxes: 'Back to boxes',
    gameYouWon: 'You won',
    buy: 'Buy',
    cancel: 'Cancel',
    gameBoxGenesis: 'Genesis Pack',
    gameBoxMatrix: 'Matrix Crate',
    gameBoxQuantum: 'Quantum Capsule',
    gameBoxVault: 'Secure Vault',
    gameBoxLiquidity: 'Liquidity Locker',
    gameBoxWhale: 'Whale Chest',
    profile: 'Profile',
  ...
  GERMAN: {
    ...
    syntrixGameTitle: 'Syntrix Game',
    upTo: 'Bis zu',
    gameSubtitle: 'Kaufe eine Box und drehe das Roulette',
    gameTokenBalance: 'Token-Guthaben',
    gameTokenLabel: 'Tokens',
    gameNotEnough: 'Nicht genug Tokens',
    gameInsufficientTokens: 'Unzureichende Tokens',
    gameConfirmTitle: 'Kauf bestätigen',
    gameConfirmText: 'Möchtest du kaufen',
    gameFor: 'für',
    gameRouletteTitle: 'Roulette',
    gameSpinButton: 'Drehen',
    gameSpinning: 'Dreht…',
    gameSpinDone: 'Ergebnis bereit',
    gameBackToBoxes: 'Zurück zu den Boxen',
    gameYouWon: 'Du hast gewonnen',
    buy: 'Kaufen',
    cancel: 'Abbrechen',
    gameBoxGenesis: 'Genesis-Paket',
    gameBoxMatrix: 'Matrix-Kiste',
    gameBoxQuantum: 'Quanten-Kapsel',
    gameBoxVault: 'Sicherer Tresor',
    gameBoxLiquidity: 'Liquiditäts-Locker',
    gameBoxWhale: 'Wal-Truhe',
    profile: 'Profil',
  ...
  SPANISH: {
    ...
    syntrixGameTitle: 'Syntrix Game',
    upTo: 'Hasta',
    gameSubtitle: 'Compra una caja y gira la ruleta',
    gameTokenBalance: 'Saldo de tokens',
    gameTokenLabel: 'tokens',
    gameNotEnough: 'No hay suficientes tokens',
    gameInsufficientTokens: 'Tokens insuficientes',
    gameConfirmTitle: 'Confirmar compra',
    gameConfirmText: '¿Quieres comprar',
    gameFor: 'por',
    gameRouletteTitle: 'Ruleta',
    gameSpinButton: 'Girar',
    gameSpinning: 'Girando…',
    gameSpinDone: 'Resultado listo',
    gameBackToBoxes: 'Volver a las cajas',
    gameYouWon: 'Has ganado',
    buy: 'Comprar',
    cancel: 'Cancelar',
    gameBoxGenesis: 'Paquete Génesis',
    gameBoxMatrix: 'Caja Matrix',
    gameBoxQuantum: 'Cápsula Cuántica',
    gameBoxVault: 'Bóveda Segura',
    gameBoxLiquidity: 'Locker de Liquidez',
    gameBoxWhale: 'Cofre Ballena',
    profile: 'Perfil',
  ...
  FRENCH: {
    ...
    syntrixGameTitle: 'Syntrix Game',
    upTo: 'Jusqu’à',
    gameSubtitle: 'Achetez une box et lancez la roulette',
    gameTokenBalance: 'Solde de tokens',
    gameTokenLabel: 'tokens',
    gameNotEnough: 'Pas assez de tokens',
    gameInsufficientTokens: 'Tokens insuffisants',
    gameConfirmTitle: 'Confirmer l\'achat',
    gameConfirmText: 'Voulez-vous acheter',
    gameFor: 'pour',
    gameRouletteTitle: 'Roulette',
    gameSpinButton: 'Tourner',
    gameSpinning: 'En cours…',
    gameSpinDone: 'Résultat prêt',
    gameBackToBoxes: 'Retour aux boxes',
    gameYouWon: 'Vous avez gagné',
    buy: 'Acheter',
    cancel: 'Annuler',
    gameBoxGenesis: 'Pack Genesis',
    gameBoxMatrix: 'Caisse Matrix',
    gameBoxQuantum: 'Capsule Quantique',
    gameBoxVault: 'Coffre Sécurisé',
    gameBoxLiquidity: 'Casier de Liquidité',
    gameBoxWhale: 'Coffre Baleine',
    profile: 'Profil',
  ...
  ITALIAN: {
    ...
    syntrixGameTitle: 'Syntrix Game',
    upTo: 'Fino a',
    gameSubtitle: 'Compra una box e gira la roulette',
    gameTokenBalance: 'Saldo token',
    gameTokenLabel: 'token',
    gameNotEnough: 'Token insufficienti',
    gameInsufficientTokens: 'Token insufficienti',
    gameConfirmTitle: 'Conferma acquisto',
    gameConfirmText: 'Vuoi comprare',
    gameFor: 'per',
    gameRouletteTitle: 'Roulette',
    gameSpinButton: 'Gira',
    gameSpinning: 'Gira…',
    gameSpinDone: 'Risultato pronto',
    gameBackToBoxes: 'Torna alle box',
    gameYouWon: 'Hai vinto',
    buy: 'Compra',
    cancel: 'Annulla',
    gameBoxGenesis: 'Pack Genesis',
    gameBoxMatrix: 'Cassa Matrix',
    gameBoxQuantum: 'Capsula Quantica',
    gameBoxVault: 'Caveau Sicuro',
    gameBoxLiquidity: 'Locker Liquidità',
    gameBoxWhale: 'Scrigno Whale',
    profile: 'Profilo',
  ...
  DUTCH: {
    ...
    syntrixGameTitle: 'Syntrix Game',
    upTo: 'Tot',
    gameSubtitle: 'Koop een box en draai de roulette',
    gameTokenBalance: 'Token-saldo',
    gameTokenLabel: 'tokens',
    gameNotEnough: 'Niet genoeg tokens',
    gameInsufficientTokens: 'Onvoldoende tokens',
    gameConfirmTitle: 'Aankoop bevestigen',
    gameConfirmText: 'Wil je kopen',
    gameFor: 'voor',
    gameRouletteTitle: 'Roulette',
    gameSpinButton: 'Draaien',
    gameSpinning: 'Draait…',
    gameSpinDone: 'Resultaat klaar',
    gameBackToBoxes: 'Terug naar boxen',
    gameYouWon: 'Je hebt gewonnen',
    buy: 'Kopen',
    cancel: 'Annuleren',
    gameBoxGenesis: 'Genesis Pack',
    gameBoxMatrix: 'Matrix Kist',
    gameBoxQuantum: 'Quantum Capsule',
    gameBoxVault: 'Veilige Kluis',
    gameBoxLiquidity: 'Liquiditeit Locker',
    gameBoxWhale: 'Whale Kist',
    profile: 'Profiel',
