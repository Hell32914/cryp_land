          ...
          <div className="prose prose-invert max-w-none">
            ...
            <div className="overflow-x-auto text-sm">
              <table className="min-w-full border border-border">
                ...
                <tbody>
                  <tr><td className="border border-border px-3 py-2"><strong>Bronze</strong></td><td className="border border-border px-3 py-2">$10–$100</td><td className="border border-border px-3 py-2"><strong>0.30%</strong></td></tr>
